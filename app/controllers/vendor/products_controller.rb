class Vendor::ProductsController < Vendor::BaseController
  ...
  def update
    ...
    if @product.update(product_params)
      redirect_to vendor_products_path, notice: "Product updated successfully."
    else
  ...
  def product_params
    params.require(:product).permit(:name, :description, :size, :price, :stock_quantity, :active, :image, :bottles_per_pack)
  end
end
